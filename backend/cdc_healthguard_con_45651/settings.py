"""
Django settings for cdc_healthguard_con_45651 project.
...
ROOT_URLCONF = 'cdc_healthguard_con_45651.urls'
...
WSGI_APPLICATION = 'cdc_healthguard_con_45651.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cdc_healthguard_con_45651 API",
    "DESCRIPTION": "API documentation for cdc_healthguard_con_45651 App",
    "VERSION": "v1",
}
